    ...
    try {
        ...
        if (data.tp_usuario === 2) {
            if (currentPageName === "index.html") {
                ...
                window.location.replace("index-professional.html");
                return;
            }
            ...
            // Para progress.html (relatórios), garantir que não renderize tela de paciente
            if (currentPageName === "progress.html") {
                console.log("✔ Profissional acessando relatórios");
                return;
            }
        }
